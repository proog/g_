...
angular.module("games").factory("Games",["$resource","upload","$http",function(t,e,i){var n=t("api/users/:userId/games/:id",{id:"@id",userId:"@user_id"},{query:{method:"GET",isArray:!0,transformResponse:function(t){var e=angular.fromJson(t);return angular.forEach(e,function(t){r(t)}),e}},get:{method:"GET",isArray:!1,transformResponse:function(t){var e=angular.fromJson(t);return r(e)}},save:{method:"POST",transformResponse:function(t){var e=angular.fromJson(t);return r(e)}},update:{method:"PUT",transformResponse:function(t){var e=angular.fromJson(t);return r(e)}}}),r=function(t){if(t.decachedImage=t.image,t.title){var e=": ",i=t.title.indexOf(e);i>-1?(t.mainTitle=t.title.substr(0,i),t.subTitle=t.title.substr(i+e.length)):t.mainTitle=t.title}return t};return n.prototype.uploadImage=function(t){var i=this;return e({url:"api/users/"+i.user_id+"/games/"+i.id+"/image",method:"POST",data:{image:t}}).then(function(t){var e=t.data;i.image=e.image,i.decachedImage=i.image+"?q="+(new Date).getTime()})},n.prototype.deleteImage=function(){var t=this;return i["delete"]("api/users/"+t.user_id+"/games/"+t.id+"/image").success(function(){t.image=null,t.decachedImage=null})},n.prototype.playtimeAsInt=function(){return this.hasPlaytime()?parseInt(this.playtime.split(":").join("")):0},n.prototype.hasPlaytime=function(){return this.playtime&&"00:00:00"!=this.playtime},n.prototype.hasRating=function(){return null!=this.rating},n.prototype.isOnWishlist=function(){return null!==this.wishlist_position},n.prototype.isInQueue=function(){return null!==this.queue_position},n.prototype.getPlaytimeDisplay=function(){if(!this.playtime)return"";var t=this.playtime.split(":"),e=t[0],i=t[1];return 0==e.indexOf("00")?e="":0==e.indexOf("0")?e=e.substr(1)+" hours":e+=" hours",0==i.indexOf("00")?i="":0==i.indexOf("0")?i=i.substr(1)+" mins":i+=" mins",e+" "+i},n}]);
