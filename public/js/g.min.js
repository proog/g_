...
angular.module("games").controller("queueFormCtrl",["$scope","$modalInstance","$filter","games","property",function(e,n,o,i,t){e.initialize=function(){e.games=angular.copy(i),e.property=t,e.filterObject={},e.filterObject[t]="!!",e.rewriteQueue()},e.rewriteQueue=function(){e.games=o("orderBy")(e.games,[e.property,"sort_as"]);var n=0;angular.forEach(e.games,function(e){null!=e[t]&&(e[t]=n++)})},e.getMaxPosition=function(){return e.games.reduce(function(e,n){return null==n[t]?e:e+1},0)-1},e.move=function(n,o){angular.forEach(e.games,function(e){e!=n&&null!=e[t]&&(e[t]>n[t]&&e[t]--,e[t]>=o&&e[t]++)}),n[t]=o},e.moveUpClick=function(n){0==n[t]?e.move(n,e.getMaxPosition()):e.move(n,n[t]-1)},e.moveDownClick=function(n){n[t]==e.getMaxPosition()?e.move(n,0):e.move(n,n[t]+1)},e.removeClick=function(n){angular.forEach(e.games,function(e){e!=n&&null!=e[t]&&e[t]>=n[t]&&e[t]--}),n[t]=null},e.saveClick=function(){e.rewriteQueue(),n.close(e.games)},e.cancelClick=function(){n.dismiss()},e.initialize()}]);
...
angular.module("games").factory("Games",["$resource","upload",function(t,e){var n=t("api/users/:userId/games/:id",{id:"@id",userId:"@user_id"},{query:{method:"GET",isArray:!0,transformResponse:function(t){var e=angular.fromJson(t);return angular.forEach(e,function(t){i(t)}),e}},get:{method:"GET",isArray:!1,transformResponse:function(t){var e=angular.fromJson(t);return i(e)}},save:{method:"POST",transformResponse:function(t){var e=angular.fromJson(t);return i(e)}},update:{method:"PUT",transformResponse:function(t){var e=angular.fromJson(t);return i(e)}}}),i=function(t){if(t.decachedImage=t.image,t.currently_playing=1==t.currently_playing,t.hidden=1==t.hidden,t.title){var e=": ",n=t.title.indexOf(e);n>-1?(t.mainTitle=t.title.substr(0,n),t.subTitle=t.title.substr(n+e.length)):t.mainTitle=t.title}return t};return n.prototype.uploadImage=function(t){var n=this;return e({url:"api/users/"+n.user_id+"/games/"+n.id+"/image",method:"POST",data:{image:t}}).then(function(t){var e=t.data;n.image=e.image,n.decachedImage=n.image+"?q="+(new Date).getTime()})},n.prototype.playtimeAsInt=function(){return this.hasPlaytime()?parseInt(this.playtime.split(":").join("")):0},n.prototype.hasPlaytime=function(){return this.playtime&&"00:00:00"!=this.playtime},n.prototype.hasRating=function(){return null!=this.rating},n.prototype.isOnWishlist=function(){return null!==this.wishlist_position},n.prototype.isInQueue=function(){return null!==this.queue_position},n.prototype.getPlaytimeDisplay=function(){if(!this.playtime)return"";var t=this.playtime.split(":"),e=t[0],n=t[1];return 0==e.indexOf("00")?e="":0==e.indexOf("0")?e=e.substr(1)+" hours":e+=" hours",0==n.indexOf("00")?n="":0==n.indexOf("0")?n=n.substr(1)+" mins":n+=" mins",e+" "+n},n}]);
