...
angular.module("games").controller("manageFormCtrl",["$scope","$modalInstance","$filter","Entities","items","gameService","$q",function(e,t,n,a,i,r,s){e.initialize=function(){e.form={},e.originalItems=i,e.items=angular.copy(i),e.type=a.prototype.type,e.STATE_UNCHANGED=1,e.STATE_ADDED=2,e.STATE_UPDATED=3,e.STATE_DELETED=4,angular.forEach(e.items,function(t){t.state=e.STATE_UNCHANGED}),e.items=n("orderBy")(e.items,"name")},e.addClick=function(){var t=new a(e.form);t.state=e.STATE_ADDED,e.items.push(t),e.form={}},e.deleteClick=function(t){t.state==e.STATE_ADDED?e.items.splice(e.items.indexOf(t)):t.state=e.STATE_DELETED},e.nameChange=function(t){t.state!=e.STATE_ADDED&&(t.state=e.STATE_UPDATED),t.short_name=t.name},e.shortNameChange=function(t){t.state!=e.STATE_ADDED&&(t.state=e.STATE_UPDATED)},e.saveClick=function(){var n=[];angular.forEach(e.items,function(t){switch(t.state){case e.STATE_ADDED:n.push(t.$save({userId:r.authenticatedUser.id},function(t){e.originalItems.push(t)}));break;case e.STATE_UPDATED:n.push(t.$update(function(n){angular.forEach(e.originalItems,function(e){e.id==t.id&&angular.copy(n,e)})}));break;case e.STATE_DELETED:n.push(t.$delete(function(){var n=e.originalItems.reduce(function(e,n,a){return n.id==t.id?a:e},-1);n>-1&&e.originalItems.splice(n,1);var i=a.prototype.ids;angular.forEach(r.games,function(e){var n=e[i].reduce(function(e,n,a){return t.id==n?a:e},-1);n>-1&&e[i].splice(n,1)})}))}}),s.all(n).then(function(){t.close()})},e.cancelClick=function(){t.dismiss()},e.canSave=function(){for(var t=0;t<e.items.length;t++){var n=e.items[t];if(!n.name||!n.short_name)return!1}return!0},e.initialize()}]);
angular.module("games").controller("queueFormCtrl",["$scope","$modalInstance","$filter","games","property","gameService","$q",function(e,n,o,i,a,t,r){e.initialize=function(){e.games=angular.copy(i),e.property=a,e.filterObject={},e.filterObject[a]="!!",e.rewriteQueue()},e.rewriteQueue=function(){e.games=o("orderBy")(e.games,[e.property,"sort_as"]);var n=0;angular.forEach(e.games,function(e){null!=e[a]&&(e[a]=n++)})},e.getMaxPosition=function(){return e.games.reduce(function(e,n){return null==n[a]?e:e+1},0)-1},e.move=function(n,o){angular.forEach(e.games,function(e){e!=n&&null!=e[a]&&(e[a]>n[a]&&e[a]--,e[a]>=o&&e[a]++)}),n[a]=o},e.moveUpClick=function(n){0==n[a]?e.move(n,e.getMaxPosition()):e.move(n,n[a]-1)},e.moveDownClick=function(n){n[a]==e.getMaxPosition()?e.move(n,0):e.move(n,n[a]+1)},e.removeClick=function(n){angular.forEach(e.games,function(e){e!=n&&null!=e[a]&&e[a]>=n[a]&&e[a]--}),n[a]=null},e.saveClick=function(){e.rewriteQueue();var o=[];angular.forEach(e.games,function(e){angular.forEach(t.games,function(n){n.id==e.id&&(n[a]=e[a],o.push(n.$update()))})}),r.all(o).then(function(){n.close()})},e.cancelClick=function(){n.dismiss()},e.initialize()}]);
