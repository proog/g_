...
angular.module("games").controller("settingsFormCtrl",["$scope","$modalInstance","gameService","Settings",function(e,n,i,t){e.initialize=function(){e.gameService=i,e.model=t.get()},e.saveClick=function(){e.model.$update().then(function(){i.refreshConfig().then(function(){n.close()})},function(){e.error=!0})},e.cancelClick=function(){n.dismiss()},e.closeAlert=function(){e.error=!1},e.initialize()}]);
...
angular.module("games").factory("Genres",["$resource",function(r){var e=r("api/users/:userId/genres/:id",{id:"@id",userId:"@user_id"},{update:{method:"PUT"}});return e.prototype.type="genre",e.prototype.ids="genre_ids",e}]).factory("Platforms",["$resource",function(r){var e=r("api/users/:userId/platforms/:id",{id:"@id",userId:"@user_id"},{update:{method:"PUT"}});return e.prototype.type="platform",e.prototype.ids="platform_ids",e}]).factory("Tags",["$resource",function(r){var e=r("api/users/:userId/tags/:id",{id:"@id",userId:"@user_id"},{update:{method:"PUT"}});return e.prototype.type="tag",e.prototype.ids="tag_ids",e}]).factory("Config",["$resource",function(r){var e=r("api/config");return e}]).factory("Settings",["$resource",function(r){var e=r("api/settings",{},{update:{method:"PUT"}});return e}]);
...
angular.module("games").service("gameService",["Games","Genres","Platforms","Tags","Users","$q","$routeParams","$http","$filter","Config",function(e,n,t,r,i,s,u,a,o,f){var c=this;c.refreshGames=function(n){return e.query({userId:n}).$promise.then(function(e){c.games=e})},c.refreshGenres=function(e){return n.query({userId:e}).$promise.then(function(e){c.genres=e})},c.refreshPlatforms=function(e){return t.query({userId:e}).$promise.then(function(e){c.platforms=e})},c.refreshTags=function(e){return r.query({userId:e}).$promise.then(function(e){c.tags=e})},c.refreshUsers=function(){return i.query().$promise.then(function(e){c.users=e})},c.refreshSuggestions=function(e){return a.get("api/users/"+e+"/suggestions").success(function(e){c.suggestions=e})},c.refreshConfig=function(){return f.get().$promise.then(function(e){c.config=e})},c.refreshAll=function(e){return c.resetAll(),s.all([c.refreshGames(e),c.refreshGenres(e),c.refreshPlatforms(e),c.refreshTags(e),c.refreshSuggestions(e),c.refreshUsers(),c.refreshConfig()]).then(function(){c.initialized=!0})},c.resetAll=function(){c.initialized=!1,c.games=[],c.genres=[],c.platforms=[],c.tags=[],c.suggestions=[],c.users=[],c.config=null},c.logIn=function(e,n){var t="api/login";return e||n?a.post(t,{username:e,password:n}).then(function(e){var n=e.data;return c.authenticated=!0,c.authenticatedUser=n,n}):a.get(t).then(function(e){var n=e.data;return c.authenticated=!0,c.authenticatedUser=n,n})},c.logOut=function(){return a.post("api/logout").then(function(){c.authenticated=!1,c.authenticatedUser=null})},c.assistedCreationSearch=function(e){return a.get("api/assisted/search/"+encodeURIComponent(e)).then(function(e){return e.data})},c.assistedCreationGetGame=function(e){return a.get("api/assisted/game/"+e).then(function(e){return e.data})},c.isGameVisible=function(e){return!e.hidden||c.authenticated&&c.authenticatedUser.id==e.user_id},c.getOwnedGames=function(){return o("filter")(c.games,function(e){return e.isOnWishlist()?!1:c.isGameVisible(e)})},c.getWishlistGames=function(){return o("filter")(c.games,function(e){return e.isOnWishlist()?c.isGameVisible(e):!1})},c.getQueuedGames=function(){return o("filter")(c.getOwnedGames(),function(e){return e.isInQueue()})},c.getFinishedGames=function(){return o("filter")(c.getOwnedGames(),function(e){return e.finished==c.FINISHED})},c.getUnfinishedGames=function(){return o("filter")(c.getOwnedGames(),function(e){return e.finished!=c.FINISHED})},c.getYears=function(){var e=[];return angular.forEach(c.getOwnedGames(),function(n){n.year&&e.indexOf(n.year)<0&&e.push(n.year)}),e},c.countFinished=function(){return c.getOwnedGames().reduce(function(e,n){return n.finished==c.FINISHED?e+1:e},0)},c.countFinishedPct=function(){return Math.round(c.countFinished()/c.getOwnedGames().length*100)},c.countGenre=function(e){return c.getOwnedGames().reduce(function(n,t){return t.genre_ids.indexOf(e.id)>-1?n+1:n},0)},c.countPlatform=function(e){return c.getOwnedGames().reduce(function(n,t){return t.platform_ids.indexOf(e.id)>-1?n+1:n},0)},c.countTag=function(e){return c.getOwnedGames().reduce(function(n,t){return t.tag_ids.indexOf(e.id)>-1?n+1:n},0)},c.isInSuggestions=function(e){return c.suggestions.reduce(function(n,t){return n||t.game_id==e.id},!1)},c.FILTER_TITLE=1,c.FILTER_PLATFORM=2,c.FILTER_GENRE=3,c.FILTER_TAG=4,c.FILTER_YEAR=5,c.FILTER_RATING=6,c.FILTER_COMPLETION=7,c.FILTER_TITLE=8,c.FILTER_YEAR_MIN=9,c.FILTER_YEAR_MAX=10,c.FILTER_RATING_MIN=11,c.FILTER_RATING_MAX=12,c.NOT_FINISHED=0,c.FINISHED=1,c.FINISHED_NA=2,c.SHELVED=3,c.authenticated=!1,c.authenticatedUser=null,c.resetAll()}]);
