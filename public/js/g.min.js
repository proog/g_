...
angular.module("games").service("gameService",["Games","Genres","Platforms","Tags","Users","$q","$routeParams","$http","$filter",function(e,n,t,r,s,i,u,f,a){var o=this;o.refreshGames=function(n){return e.query({userId:n}).$promise.then(function(e){o.games=e})},o.refreshGenres=function(e){return n.query({userId:e}).$promise.then(function(e){o.genres=e})},o.refreshPlatforms=function(e){return t.query({userId:e}).$promise.then(function(e){o.platforms=e})},o.refreshTags=function(e){return r.query({userId:e}).$promise.then(function(e){o.tags=e})},o.refreshUsers=function(){return s.query().$promise.then(function(e){o.users=e})},o.refreshSuggestions=function(e){return f.get("api/users/"+e+"/suggestions").success(function(e){o.suggestions=e})},o.refreshConfig=function(){return f.get("api/config").success(function(e){o.config=e})},o.refreshAll=function(e){return o.resetAll(),i.all([o.refreshGames(e),o.refreshGenres(e),o.refreshPlatforms(e),o.refreshTags(e),o.refreshSuggestions(e),o.refreshUsers(),o.refreshConfig()]).then(function(){o.initialized=!0})},o.resetAll=function(){o.initialized=!1,o.games=[],o.genres=[],o.platforms=[],o.tags=[],o.suggestions=[],o.users=[],o.config=null},o.checkLogin=function(){return f.get("api/login").success(function(e){o.authenticated=!0,o.authenticatedUser=e})},o.assistedCreationSearch=function(e){return f.get("api/assisted/search/"+encodeURIComponent(e)).then(function(e){return e.data})},o.assistedCreationGetGame=function(e){return f.get("api/assisted/game/"+e).then(function(e){return e.data})},o.isGameVisible=function(e){return!e.hidden||o.authenticated&&o.authenticatedUser.id==e.user_id},o.getOwnedGames=function(){return a("filter")(o.games,function(e){return e.isOnWishlist()?!1:o.isGameVisible(e)})},o.getWishlistGames=function(){return a("filter")(o.games,function(e){return e.isOnWishlist()?o.isGameVisible(e):!1})},o.getQueuedGames=function(){return a("filter")(o.getOwnedGames(),function(e){return e.isInQueue()})},o.getFinishedGames=function(){return a("filter")(o.getOwnedGames(),function(e){return e.finished==o.FINISHED})},o.getUnfinishedGames=function(){return a("filter")(o.getOwnedGames(),function(e){return e.finished!=o.FINISHED})},o.getYears=function(){var e=[];return angular.forEach(o.getOwnedGames(),function(n){n.year&&e.indexOf(n.year)<0&&e.push(n.year)}),e},o.countFinished=function(){return o.getOwnedGames().reduce(function(e,n){return n.finished==o.FINISHED?e+1:e},0)},o.countFinishedPct=function(){return Math.round(o.countFinished()/o.getOwnedGames().length*100)},o.countGenre=function(e){return o.getOwnedGames().reduce(function(n,t){return t.genre_ids.indexOf(e.id)>-1?n+1:n},0)},o.countPlatform=function(e){return o.getOwnedGames().reduce(function(n,t){return t.platform_ids.indexOf(e.id)>-1?n+1:n},0)},o.countTag=function(e){return o.getOwnedGames().reduce(function(n,t){return t.tag_ids.indexOf(e.id)>-1?n+1:n},0)},o.isInSuggestions=function(e){return o.suggestions.reduce(function(n,t){return n||t.game_id==e.id},!1)},o.FILTER_TITLE=1,o.FILTER_PLATFORM=2,o.FILTER_GENRE=3,o.FILTER_TAG=4,o.FILTER_YEAR=5,o.FILTER_RATING=6,o.FILTER_COMPLETION=7,o.FILTER_TITLE=8,o.FILTER_YEAR_MIN=9,o.FILTER_YEAR_MAX=10,o.FILTER_RATING_MIN=11,o.FILTER_RATING_MAX=12,o.NOT_FINISHED=0,o.FINISHED=1,o.FINISHED_NA=2,o.SHELVED=3,o.authenticated=!1,o.authenticatedUser=null,o.resetAll()}]);